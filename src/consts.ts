...
export const SITE_DESCRIPTION = 'Software Engineering student (minor in Data Science & AI) based in Madrid. Currently interning at MGA, migrating spreadsheet-based workflows into PostgreSQL and Spring Boot. I also build game engines, make pixel art, and over-engineer a home server.';
